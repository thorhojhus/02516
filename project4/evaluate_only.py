"""
Evaluation-only script - loads existing checkpoint and generates results.
"""
import warnings
import json
...
def main():
    ...
    checkpoint_path = Path("project4/checkpoints/best_model.pth")
    ...
    # Data loaders
    _, val_loader = make_pothole_proposal_loaders(
    ...
    ap, precisions, recalls, total_gt, total_tp, total_fp = compute_map(
        ...
        image_size=224, testset="test_selective_search_v2.json"
    )
    ...
    print(f"Detection Recall: {total_tp/total_gt:.4f}")
    ...
    if precisions and recalls:
        ...
        plt.close()
        print(f"\nSaved PR curve to {results_dir / 'precision_recall_curve.png'}")
